	  ...
	  (defun dim:c-pgsql-mode-hook ()
	    (when (and buffer-file-name
			   ...
			   (string-match "pgsrc" buffer-file-name)
                           ...
                           (string-match "subcommands" buffer-file-name)
			   (string-match "pgext" buffer-file-name)
			   (string-match "cqueue" buffer-file-name)
			   (string-match "citus" buffer-file-name)
			   (string-match "citus-ha" buffer-file-name)
			   (string-match "blackhole" buffer-file-name)
